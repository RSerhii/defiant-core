...
if (BROWSER_CONFIG.slug !== "edge") {
    /**
     * @description - Within the URL box, type "dissent" to search The Hive.com
     */
    chrome.omnibox.onInputEntered.addListener(function(text, disposition) {
        // Encode user input for special characters , / ? : @ & = + $ #
        var newURL = 'https://thehive.com/search?q=' + encodeURIComponent(text);
...
/**
 * @description - GDEStorage - Gab The Hive Extension Storage
 */
function GDEStorage() {
    //Global scope
    var scope = this;
